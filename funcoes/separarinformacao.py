...
def separar_info():
    ...
    return tweet_id, airline_sentiment, sentiment_c, negativereason, negativereason_confidence, airline, airline_sentiment_gold, retweet_count, text, tweet_coord, tweet_created, tweet_location, user_timezone
